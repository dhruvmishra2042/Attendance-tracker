...
app.use(cors());
mongoose.connect('mongodb+srv://shinningstar2137:dhruv@cluster0.b1apdtv.mongodb.net/Attendance', {
...
app.post('/insert', async (req, res) => {
    ...
    const student = new StudentModels({ name: name, rollNumber: rollnumber });
    try {
        await student.save();
